Ext.define('PP.view.form.FormDeletedController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.form_deleted',

    report_csv: function (grid, rowIndex) {
        var rec = grid.getStore().getAt(rowIndex);
        Ext.Ajax.request({
            url: 'api/form_deleted/' + rec.id + '/votes',
            method: "GET",
    ...
    question_answers: function (grid, rowIndex) {
        ...
        var store = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                type: 'rest',
                url: 'api/form_deleted/' + rec.get('form_id') + '/question/' + rec.id + '/answer',
                reader: {
                    type: 'json',
                    rootProperty: 'data'
                },
    ...
    questions: function (grid, rowIndex) {
        ...
        var store = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                type: 'rest',
                url: 'api/form_deleted/' + rec.id + '/question',
                reader: {
                    type: 'json',
                    rootProperty: 'data'
                },
